...
<body class="antialiased">
        <div class="text-gray-900 text-sm">
            <nav class="bg-gray-900 text-white px-4 py-3 flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <a href="#" class="text-white hover:text-gray-400">
                        <svg aria-hidden="true" viewBox="0 0 16 16"  data-view-component="true" class="w-8 fill-current">
                ...
                <div class="flex items-center space-x-4 text-white">
                    ...
                    <a href="#" class="flex items-center hover:text-gray-400">
                        ...
                        <svg class="w-3 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>

                    </a>
                    <a href="#" class="flex items-center hover:text-gray-400">
                        <img class="rounded-full w-5 h-5" src="https://avatars.githubusercontent.com/u/24208222?s=40&v=4">
                        <svg class="w-3 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </a>
            ...
            <div class="repo-stats flex items-center justify-between px-8 py-4">
                <div class="flex">
                    <svg class="w-4 fill-current text-gray-600" aria-hidden="true" viewBox="0 0 16 16" data-view-component="true">
                    ...
                    <div class="flex items-center text-xl ml-2">
                        <a href="#" class="text-blue-600 hover:underline">rgerits</a>
                        <span class="ml-1">/</span>
                        <a href="#" class="text-blue-600 hover:underline ml-1 font-semibold">rgerits</a>
                    </div>
                </div>
                <div class="flex space-x-2 ">
                    <div class="flex text-sm">
                        <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-center space-x-1">
                            ...
                            <div>Watch</div>
                            <svg class="w-4 pt-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                            </svg>
                        </button>
                        <a href="#" class="border border-gray-400 rounded rounded-l-none border-l-0 px-3 py-1 font-semibold hover:text-blue-600">430</a>
                    </div>
                    <div class="flex text-sm">
                        <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-centere space-x-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    ...
                    <div class="flex text-sm">
                        <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-centere space-x-1">
                            <svg aria-hidden="true" viewBox="0 0 16 16" data-view-component="true" class="w-4 h-4 pt-1">
            ...
            <div class="container mx-auto my-8 px-4 flex">
                <div class="file-explorer-container w-3/4 mr-8">
                    <div class="branch-navigation flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="#" class="flex items-center space-x-2 px-3 py-1 group">
                                <svg text="gray" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="fill-current text-gray-600 group-hover:text-blue-600 w-4">
                                    <path d="M9.5 3.25a2.25 2.25 0 1 1 3 2.122V6A2.5 2.5 0 0 1 10 8.5H6a1 1 0 0 0-1 1v1.128a2.251 2.251 0 1 1-1.5 0V5.372a2.25 2.25 0 1 1 1.5 0v1.836A2.493 2.493 0 0 1 6 7h4a1 1 0 0 0 1-1v-.628A2.25 2.25 0 0 1 9.5 3.25Zm-6 0a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Zm8.25-.75a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5ZM4.25 12a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Z"></path>
                                </svg>
                                <span class="font-semibold group-hover:text-blue-600">3</span>
                                <span class="group-hover:text-blue-600">branches</span>
                            </a>
                            <a href="#" class="flex items-center space-x-2 px-3 py-1 group">
                                <svg text="gray" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="fill-current text-gray-600 group-hover:text-blue-600 w-4">
                                    <path d="M1 7.775V2.75C1 1.784 1.784 1 2.75 1h5.025c.464 0 .91.184 1.238.513l6.25 6.25a1.75 1.75 0 0 1 0 2.474l-5.026 5.026a1.75 1.75 0 0 1-2.474 0l-6.25-6.25A1.752 1.752 0 0 1 1 7.775Zm1.5 0c0 .066.026.13.073.177l6.25 6.25a.25.25 0 0 0 .354 0l5.025-5.025a.25.25 0 0 0 0-.354l-6.25-6.25a.25.25 0 0 0-.177-.073H2.75a.25.25 0 0 0-.25.25ZM6 5a1 1 0 1 1 0 2 1 1 0 0 1 0-2Z"></path>
                                </svg>
                                <span class="font-semibold group-hover:text-blue-600">0</span>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="border border-gray-400 rounded-md text-white bg-green-500 hover:bg-green-600 px-4 py-1 flex items-center space-x-2">
                                <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="text-white fill-current">
                                    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
                                </svg>
                                <div>Code</div>
                                <svg class="w-4 pt-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div class="div readme-container rounded-md border border-gray-400 px-6 py-4 mt-4">
                        <h4 class="font-semibold">README.md</h4>
                        <div>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi doloremque esse et nemo nisi quisquam rem, similique! Dolore eaque est fugit labore nesciunt, nostrum quidem repellat reprehenderit soluta temporibus ullam?
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi doloremque esse et nemo nisi quisquam rem, similique! Dolore eaque est fugit labore nesciunt, nostrum quidem repellat reprehenderit soluta temporibus ullam?
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi doloremque esse et nemo nisi quisquam rem, similique! Dolore eaque est fugit labore nesciunt, nostrum quidem repellat reprehenderit soluta temporibus ullam?
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi doloremque esse et nemo nisi quisquam rem, similique! Dolore eaque est fugit labore nesciunt, nostrum quidem repellat reprehenderit soluta temporibus ullam?
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi doloremque esse et nemo nisi quisquam rem, similique! Dolore eaque est fugit labore nesciunt, nostrum quidem repellat reprehenderit soluta temporibus ullam?
            ...
            <footer class="container mx-auto text-xs border-t border-gray-400 py-10 flex items-center justify-between">
                ...
                <div class="mx-16">
                    <a href="#">
                        <svg aria-hidden="true" height="24" viewBox="0 0 16 16" version="1.1" width="24" data-view-component="true" class="w-6 fill-current text-gray-400 hover:text-gray-600">
                            <path d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.31 2.69.94 0 .67.01 1.3.01 1.49 0 .21-.15.45-.55.38A7.995 7.995 0 0 1 0 8c0-4.42 3.58-8 8-8Z"></path>
                        </svg>
                    </a>
                </div>
